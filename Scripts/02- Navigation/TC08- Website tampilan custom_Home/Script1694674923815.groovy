...
WebUI.click(findTestObject('Object Repository/Page_House of Shopaholic/div_New Arrivals_flex layout align-center c_764072'))

WebUI.click(findTestObject('Object Repository/Page_House of Shopaholic/img_Confirmation_cursor-pointer'))
