...
WebUI.setText(findTestObject('Object Repository/Page_Password Reminder  Vendpad/input_Password Reminder_email'), 'akundemo859@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_Password Reminder  Vendpad/input_Password Reminder_btn btn-pin'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Password Reminder  Vendpad/div_Close  Password reminder sent'))
